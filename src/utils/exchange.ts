import { Currency, CurrencyAmount, Fraction, Percent, Trade, TradeType } from 'libraries/swap-sdk'
...
export function useRouterContract() {
  ...
  return useContract(chainId && ROUTER_ADDRESS[chainId], pancakeRouter02ABI)
}
