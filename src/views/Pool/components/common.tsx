...
import { Currency, Fraction, Percent, CurrencyAmount, Token } from 'libraries/swap-sdk'
import { Text, Box, Flex, Svg, SvgProps } from 'components'
...
const Subtitle: React.FC<React.PropsWithChildren> = ({ children }) => {
  return (
    <Text fontSize="12px" textTransform="uppercase" color="secondary">
      {children}
    </Text>
  )
}
...
export const AddLiquidityModalHeader = ({
  ...
  return (
    <AutoColumn gap="24px">
      ...
      <RowBetween>
        <Subtitle>Your share in the pair</Subtitle>
